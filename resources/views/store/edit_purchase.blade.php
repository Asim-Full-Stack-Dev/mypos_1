        ...
        <div class="content">
            <div class="row">
                <div class="container">
                    ...
                    @endif
                    <form action="{{ url('update_purchase/'.$purchases->id) }}" method="POST"
                          enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="card-body card-block">
                            <div class="card-header text-center"><strong>EDIT PURCHASE</strong><small> Form</small>
                            </div>
                        </div>
                        <div class="card-body card-block">
                            <div class="row form-group">
                                <div class="col-6">
                                    <div class="form-group"><label for="company" class=" form-control-label">Product
                                            Name</label><input type="text" name="p_name" value="{{$purchases->p_name}}"
                                                               placeholder="Product Name" class="form-control"></div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group"><label for="vat" class=" form-control-label">Product
                                            Size</label><input type="text" name="p_size" value="{{$purchases->p_size}}"
                            ...
                            <div class="row form-group">
                                <div class="col-6">
                                    <div class="form-group"><label for="street" class=" form-control-label">Product
                                            Color</label><input type="text" name="p_color"
                                                                value="{{$purchases->p_color}}"
                                                                placeholder="Product Color" class="form-control"></div>
                                </div>
                                <div class="col-6">
                                    <div class="form-group"><label for="city" class=" form-control-label">Purchase
                                            Price</label><input type="text" name="p_price"
                                                                value="{{$purchases->p_price}}"
                            ...
                            <div class="form-group"><label for="File input" class=" form-control-label">Product
                                ...
                                <img src="{{ asset('uploads/purchase/'.$purchases->image) }}" width="100px"
                                     height="100px" alt="Image">
                            </div>
                            <div class="form-actions form-group text-center">
                                <button type="submit" class="btn btn-primary btn-sm">Update Purchase</button>
                            </div>
                        </div>
                    </form>
                </div>
