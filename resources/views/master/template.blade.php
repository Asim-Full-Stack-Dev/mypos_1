            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-puzzle-piece"></i><a href="{{route('add_purchase')}}">add purchase</a></li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href="{{route('add_stock')}}">Add Stock</a></li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-th"></i><a href="{{route('add_expense')}}">Add Expense Tracker</a>
                        </li>
                        <li><i class="menu-icon fa fa-th"></i><a href="{{route('expense_list')}}">Expense Tracker
                                List</a></li>
                    </ul>
                </li>
...
<div id="right-panel" class="right-panel">
    ...
    <header id="header" class="header">
        <div class="top-left">
            <div class="navbar-header">
                <a class="navbar-brand mr-0 pr-0" href="./"><img class="w-50"
                                                                 src="{{asset('/home_page/asset/images/pos-logo-hr.png')}}"
                                                                 alt="Logo"></a>
                <a class="navbar-brand hidden" href="./"><img src="{{asset('/home_page/asset/images/pos-logo-hr.png')}}"
                                                              alt="Logo"></a>
    ...
    <script
        src="{{asset('https://cdn.jsdelivr.net/npm/jquery-match-height@0.7.2/dist/jquery.matchHeight.min.js')}}"></script>
    ...
    <script
        src="{{asset('https://cdn.jsdelivr.net/npm/chartist-plugin-legend@0.6.2/chartist-plugin-legen')}}d.min.js"></script>
